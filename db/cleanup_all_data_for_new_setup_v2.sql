...
truncate account_bal;
delete from account where id_company > 1;


INSERT INTO `account_bal` (
`id_acct`,
`dt_begin_bal`,
`debit_begin_bal`,
`credit_begin_bal`,
...
`dt_upd`,
`upd_by`)
SELECT id, '2025-01-01', 0.00, 0.00, '2025-01-31', 0.00, 0.00, '2025-01-31', 0.00, 0.00, 'I', now(), 'SYSTEM', now(), 'SYSTEM'
FROM account
WHERE id_company = 1;

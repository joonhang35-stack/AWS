...
public interface EInvoiceBO {
	...
	public ApiGetSubmissionResponseVO getSubmission(String submissionUid, Long idCompany)
			throws KeyManagementException, BusinessException, NoSuchAlgorithmException, IOException, JSONException, ParseException;

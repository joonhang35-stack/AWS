...
public interface SalesSmmryDAO extends BaseDAO{
	...
	public List<SalesSmmryVO> getRegionSalesSmmryBookingDetailList(Long idCompany, Long salerId, SearchParamVO searchParamVO) throws BusinessException;

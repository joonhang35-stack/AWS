...
public interface BillPymtDAO extends BaseDAO{
	 ...
	 * @return
	 */
	public List<AcctVO> getAcctListByAccCode(Long idCompany, Long expendId, Long assetId, String query);
	...
	public void updateExOrderBillEInvoiceData(Long idInv, String docUuid, String submissionUid, String status)
			throws BusinessException;

...
public interface CashBookDAO extends BaseCommonDAOLM {
	...
	/**
	 * 
	 * @param selectedCBList
	 * @param unselectedCBList
	 * @throws BusinessException
	 */
	...
	public void updateCashBookEInvoiceData(Long idCashBook, String docUuid, String submissionUid, String status)
			throws BusinessException;

...
public class AirlineScheduleVO extends BaseVO {
	...
	private List<AirlineScheduleChargeVO> extraItemChargeList;
	// for view purpose
	private AirlineScheduleItemVO[] selectedScheduleItems;
	...
	/**
	 * @return the airlineScheduleItemList
	 */
	...
	/**
	 * @param airlineScheduleItemList the airlineScheduleItemList to set
	 */
	...
	public List<AirlineScheduleChargeVO> getExtraItemChargeList() {
		return extraItemChargeList;
	}

	public void setExtraItemChargeList(List<AirlineScheduleChargeVO> extraItemChargeList) {
	 ...
	 */
	public AirlineScheduleItemVO[] getSelectedScheduleItems() {
	 ...
	 */
	public void setSelectedScheduleItems(AirlineScheduleItemVO[] selectedScheduleItems) {

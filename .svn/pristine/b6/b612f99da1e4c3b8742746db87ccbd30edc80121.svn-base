...
public interface BankAdjustBO {
	...
	public List<AcctTransViewVO> getAcctTransViewTableList(String sysNo, String typeCd, String sysCode, Long CompId) throws BusinessException;

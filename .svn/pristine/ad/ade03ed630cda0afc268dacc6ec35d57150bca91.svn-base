...
@WebServlet("/getGroupPackage")
public class getGroupPackage extends WebServiceServlet {

	   /**
	     * @see HttpServlet#HttpServlet()
	     */
	    public getGroupPackage() {
	        super();
			...
			try{ 
			    ...
			    Statement stmt = conn.createStatement();
			      ...
			      while(rs.next()){
			 		...
			 		String tempDescription = (num_days + "Days " + num_nights + "Nights ");
			 		if(!description.equals("") && description != null){
				 		tempDescription += "[" + description + "]";
			 		}
			 		
			 		 tmpObjClass.setDescription(tempDescription); 

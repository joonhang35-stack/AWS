...
public interface EInvoiceService {
	...
	public void updateRecentDocumentsToApiDailySnapshot(List<ApiDocumentQueryResponseVO> responseList, Date dtTrans, CompanyVO companyVO) throws KeyManagementException, BusinessException, NoSuchAlgorithmException, IOException, JSONException, ParseException;
	...
	public JSONObject submitCreditNoteType(EInvoiceDocumentVO vo)
			throws BusinessException, KeyManagementException, NoSuchAlgorithmException, IOException, JSONException;
	...
	public ApiGetSubmissionResponseVO getSubmission(String submissionUid, Long idCompany)
			throws BusinessException, KeyManagementException, NoSuchAlgorithmException, IOException, JSONException, ParseException;

...
public interface PaymentService {
	...
	public void updatePayment(CashBookVO cashBookVO,
			List<AcctTransVO> acctTransList) throws BusinessException;
	...
	public void updTransList(List<AcctTransViewVO> addTransList,
			List<AcctTransViewVO> updTransist, List<AcctTransViewVO> delTransList,CashBookVO cashBookVO, Long newNum,BankAcctVO bankAcctVO,AcctTransViewVO acctTransCashBookVO, LookupItemVO lookupItemCBT, SystemNumberGenerationVO sysGenCodeVO, List<AcctTransViewVO> acctTransListView) throws BusinessException;

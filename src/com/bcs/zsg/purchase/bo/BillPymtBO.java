...
public interface BillPymtBO {
	 ...
	 * @throws BusinessException
	 */
	public AcctCatVO getIncome()  throws BusinessException;
	 ...
	 * @throws BusinessException
	 */
	public List<AcctSubCatVO> getLiabilityList(Long liaId, Long companyId) throws BusinessException;

...
public interface InvoiceBO {
	 ...
	 * @throws BusinessException
	 */
	public List<CustDetailsVO> getPassangerList(String searchType, String searchValueType, String searchValuee, Long companyId) throws BusinessException;
	...
	public List<InvoiceAndExchangeOrderViewVO> getInvEOItemViewList(Long companyId, boolean acctMgr, String invoiceCatCd,
			String invItemCat, List<String> excludeInvItemCatList) throws BusinessException;
	
	/**
	 * 
	 * @param invoiceVO, tourDepartureVO
	 * @throws BusinessException
	...
	public void insertSubPaxStatement(InvoiceVO invoiceVO, Long idTourDep, boolean bySystem)
	...
	public void updateInvoice(InvoiceVO invoiceVO, Long idTourDep, Boolean isUpdateCashBook)
			throws BusinessException, QueueException;
	 ...
	 * @throws QueueException 
	 */
	public void updateInvoicePayments(InvoiceVO invoiceVO, Long idTourDep, Boolean isUpdateCashBook)
			throws BusinessException, QueueException;
	...
	public List<InvoiceVO> getInvoiceListToSubmitEInvoice(Map<String, Object> params, Date dateChecked)
			throws BusinessException;

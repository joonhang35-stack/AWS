...
public interface FeedbackDAO extends BaseDAO {
    ...
    /**
     * Retrieves pax (passenger) list for feedback dialog.
     * Uses priority: Invoice (doc_type_cd='I') > PS (doc_type_cd='P') > tour_booking
     *
     * @param tourBookingId the tour booking ID to resolve the best invoice
     * @return list of FeedbackVO, each representing one passenger
     * @throws BusinessException
     */
